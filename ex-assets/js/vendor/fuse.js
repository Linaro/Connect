...
(function (global, factory) {
  ...
  var LOGICAL_SEARCH_INVALID_QUERY_FOR_KEY = function LOGICAL_SEARCH_INVALID_QUERY_FOR_KEY(
    key
  ) {
  ...
  function search(text, pattern, patternAlphabet) {
    ...
    var mask =
      1 << (patternLen <= MAX_BITS - 1 ? patternLen - 1 : MAX_BITS - 2);
    ...
    _createClass(Fuse, [
      ...
      },
      {
        ...
        value: function _searchLogical(query) {
          ...
          var evaluateExpression = function evaluateExpression(
            node,
            item,
            idx
          ) {
