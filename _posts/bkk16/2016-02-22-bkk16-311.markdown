...
excerpt: "- What we mean by EAS core and how it's distinct from the other components
  ...
  An update on misc work that's underway to resolve the upstreaming.,   - Misc load
  balance pathway enhancements,   - Wakeup pathway mods (cleanups, basic big.LITTLE
  ...
  struct sched_group_energy., , - How we are structuring things to ease upstream acceptance.
