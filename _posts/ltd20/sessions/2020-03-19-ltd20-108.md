...
description: '<strong>To join this session live please go to:</strong><br><ul><li>YouTube:
  ...
  dont have a way to do so.<br><br>Our solution is to open up the build scripts in
  a github project, together with supplement mechanism to prepare the build environment
...
image:
  featured: 'true'
  path: /assets/images/featured-images/san19/LTD20-108.png
