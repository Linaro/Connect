...
categories:
- bkk19
description: '> From hardware to the application layer and everything in between.
  Fedora IoT will package the Mozilla IoT "Things Gateway" framework and showcase
  it all being deployed on a variety of 96Boards! Find out more about this collaboration
...
- speaker_bio: Robert Wolff is a technical writer, open source evangelist, community
    ...
    graduated from University of California, San Diego with a bachelor's degree in
  ...
  speaker_image: /assets/images/speakers/bkk19/RobertWolff.jpg
