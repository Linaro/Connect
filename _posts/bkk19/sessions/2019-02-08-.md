...
description: '> o 5 min, ROHM, the company introduction<br>o 5 min, Basic for Sensor
  ...
  5 min, Basic for Sensor IIO driver<br>o 5 min, Basic for Power device driver<br>o
  25 min, Demo, Sensor UPM driver build and flash to 96Boards (Give away Sensor boards
  for 96Boards)'
future_image:
  featured: 'true'
  path: /assets/images/featured-images/bkk19/BKK19-316.png
session_attendee_num: '0'
session_id: BKK19-316
...
- speaker_bio: ''
  ...
  speaker_location: ''
  speaker_name: Heikki Haikola
  speaker_position: ''
  speaker_username: heikki.haikola
- speaker_bio: '- Leading software developments team in Finland.<br>- Over 20 years
  ...
  speaker_company: ''
  speaker_image: /assets/images/speakers/bkk19/KokiOkada.jpg
  speaker_location: ''
