...
image:
  featured: true
  name: LinaroConnectBudapest(BUD17)Registrationhaslaunched!.png
  path: /assets/images/featured-images/LinaroConnectBudapest(BUD17)Registrationhaslaunched!.png
layout: post
