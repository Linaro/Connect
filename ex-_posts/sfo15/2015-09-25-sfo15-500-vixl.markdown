...
excerpt: "VIXL is dynamic code generation toolkit for Armv8 that we hope will enable
  ...
  will introduce you to what VIXL is, what’s new in VIXL and how to use it and take
  advantage of all its components that cover all the aspects of software development
  on Arm CPUs."
