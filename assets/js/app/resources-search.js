...
function createTableRows(data){
    ...
    $.each(data, function (key, val) {
        ...
        if (typeof object.youtube_video_url !== 'undefined' && object.youtube_video_url !== "") {
            video = "<a href='" + object.youtube_video_url + "'>View</a>";
        }
        else if (typeof object.amazon_s3_video_url !== 'undefined' && object.amazon_s3_video_url !== "") {
            video = "<a href='" + object.amazon_s3_video_url + "'>View</a>";
        }
        else if (object.youtube_video_url === "" && object.amazon_s3_video_url === "") {
            video = "<a target='_blank' href='" + object.url + "'>View</a>";
        }

        // Get Presentations
        var presentation = "Not available";
        if (typeof object.slideshare_presentation_url !== 'undefined' && object.slideshare_presentation_url !== "") {
            presentation = "<a target='_blank' href='" + object.slideshare_presentation_url + "'>View</a>";
        }
        else if (typeof object.amazon_s3_presentation_url !== 'undefined') {
            presentation = "<a target='_blank' href='" + object.amazon_s3_presentation_url + "'>View</a>";
        }
        else if (object.amazon_s3_presentation_url === "" && object.slideshare_presentation_url === "")
        {
        ...
        if (object.speakers !== "") {
            ...
            if (object.speakers !== "None") {
                $.each(object.speakers, function (index, value) {
                    speakers += value.name + " - " + value["job-title"] + "(" + value.company + "), ";
                });
            }
            // Remove the last ", "
